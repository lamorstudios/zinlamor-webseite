...
export function MobileActionBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-sand/40 bg-cream-soft/95 backdrop-blur-md pb-[env(safe-area-inset-bottom)] lg:hidden">
      <div className="grid grid-cols-3">
        <Link
          href="/reservierung"
          className="flex flex-col items-center justify-center gap-0.5 py-2.5 text-burgundy"
        >
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-0.5 border-x border-sand/40 py-2.5 text-charcoal/80"
        >
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-0.5 py-2.5 text-charcoal/80"
        >
