        ...
        <div className="container-content grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="max-w-prose">
            ...
            <ul className="mt-6 grid gap-3">
              {points.map((p) => (
                <li key={p} className="flex items-start gap-2.5 text-fluid-base text-ink/80">
          ...
          <Figure src="/images/franchise/restaurant.jpg" alt="La Tasca Flamenca Restaurant" tone="ink" ratio="aspect-[4/5]" label="Dein Standort" />
        </div>
      </section>
    </>
  );
